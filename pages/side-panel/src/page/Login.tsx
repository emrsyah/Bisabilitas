...
const Login = (props: Props) => {
  return (
    <form onSubmit={props.handleLogin} className="mx-4 sm:mx-auto py-6 min-h-screen flex gap-2 flex-col">
      {/* <ButtonKembali /> */}
      {props.children}
      <h1 className="text-2xl font-bold text-yellow-800">Masuk Bisabilitas</h1>
      ...
      <span className="text-base font-medium text-gray-700 mt-1 flex items-center text-center">
        Belum punya akun?{' '}
        <button type="button" onClick={() => props.setMode('register')} className="text-yellow-800 underline ml-1">
          Daftar
        </button>
      </span>
    </form>
